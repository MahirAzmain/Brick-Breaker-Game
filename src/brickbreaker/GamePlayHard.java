...
/*public class GamePlayHard extends JPanel implements KeyListener, ActionListener {
    ...
    private MapGeneratorHard mp;

    public GamePlayHard() {
        mp = new MapGeneratorHard(6, 8);
        addKeyListener(this);
        setFocusable(true);
    ...
    public void paint(Graphics g) {
        ...
        //paddle
        Color c2 = new Color(0, 51, 51);
        g.setColor(c2);
        g.fillRect(playerX, 550, 100, 8);

        //ball
        Color c3 = new Color(102, 102, 0);
        g.setColor(c3);
...
public class GamePlayHard extends JPanel implements KeyListener, ActionListener {
    ...
    private int lives=3;
    private int brickCounter=0;
    private int stick_width=85;

    private MapGeneratorHard mp;
   
   
    public GamePlayHard() {
        mp = new MapGeneratorHard(row, col);
        addKeyListener(this);
        setFocusable(true);
        setFocusTraversalKeysEnabled(false);
        timer = new Timer(delay, this);
...
//                m.setVisible(true);
   ...
   public void actionPerformed(ActionEvent e) {
        ...
        if (play) {
            if (new Rectangle(ballPosX, ballPosY, 15-level, 15-level).intersects(new Rectangle(playerX, 550, stick_width, 8))) {
                ballYDir = -ballYDir;
            }
            A:
            for (int i = 0; i < mp.map.length; i++) {
